...
def _mlp(hiddens, inpt, num_actions, scope, reuse=False, layer_norm=False, act_fun=tf.nn.relu):
...
def mlp(hiddens=[], layer_norm=False, act_fun=tf.nn.relu):
...
def _cnn_to_mlp(convs, hiddens, dueling, inpt, num_actions, scope,
                    reuse=False, layer_norm=False, act_fun=tf.nn.relu):
    with tf.variable_scope(scope, reuse=reuse):
        out = inpt
